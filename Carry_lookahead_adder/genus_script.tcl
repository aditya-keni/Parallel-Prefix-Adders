...
set rtlFiles [list Carry_lookahead_adder.v CLA_group_PG.v Bitwise_PG.v Final_sum.v Gray_cell.v Black_cell.v]   ;# All HDL files

set basename Carry_lookahead_adder            ;# name of top level module
