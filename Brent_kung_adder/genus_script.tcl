...
set rtlFiles [list Brent_kung_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v Black_cell.v Brent_kung_grp_PG.v]   ;# All HDL files

set basename Brent_kung_adder      ;# name of top level module
