...
set rtlFiles [list Carry_skip_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v CSA_group_PG.v]   ;# All HDL files

set basename Carry_skip_adder      ;# name of top level module
