...
set rtlFiles [list Han_carlson_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v HC_grp_PG.v Black_cell.v]   ;# All HDL files

set basename Han_carlson_adder      ;# name of top level module
