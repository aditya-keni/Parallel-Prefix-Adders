...
set rtlFiles [list Knowles_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v Knowles_grp_PG.v Black_cell.v]   ;# All HDL files

set basename Knowles_adder      ;# name of top level module
