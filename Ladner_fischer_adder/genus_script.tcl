...
set rtlFiles [list Ladner_fischer_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v LF_grp_PG.v Black_cell.v]   ;# All HDL files

set basename Ladner_fischer_adder      ;# name of top level module
