...
set rtlFiles [list Kogge_stone_adder.v Bitwise_PG.v Final_sum.v Gray_cell.v Black_cell.v KS_grp_PG.v]   ;# All HDL files

set basename Kogge_stone_adder      ;# name of top level module
