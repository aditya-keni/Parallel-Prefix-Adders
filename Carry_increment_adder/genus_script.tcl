...
set rtlFiles [list Carry_inc_adder.v Carry_inc_grp_PG.v Bitwise_PG.v Final_sum.v Gray_cell.v Black_cell.v]   ;# All HDL files

set basename Carry_inc_adder            ;# name of top level module
